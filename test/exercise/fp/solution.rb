  ...
  module Fp
    class << self
      ...
      def rating(array)
        ...
        rating_to_count = array.reduce([]) { |movies, movie| has_many_countries.call(movie) ? movies << movie : movies }
      ...
      def chars_count(films, threshold)
        ...
        films
          .reduce([]) { |rated_movies, movie| has_needed_rating.call(movie) ? rated_movies << movie : rated_movies }
